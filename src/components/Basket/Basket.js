...
function Basket() {
  ...
  function makePurchase(e) {
    e.preventDefault();
    if (purchaseDetails.name != "" && purchaseDetails.number != "") {
      dispatch(checkout(purchaseDetails)).then((response) => {
      ...
      >
            ...
            >
              ...
              <span style={{ display: "flex" }}>
                <p style={{ marginLeft: "-15px" }}>
                  ...
                  <span>{(((100 - item.discount) / 100) * item.price).toFixed(0)}KM</span>
                </p>
                <DeleteIcon
        ...
        <Grid>
          ...
          >
            ...
            >
              Ukupna cijena: {purchaseDetails.price.toFixed(0)}KM
            </h1>
            <TextField
              required
              name="name"
